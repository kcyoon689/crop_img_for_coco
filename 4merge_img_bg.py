...
class AutoGenerate_bg:
    def __init__(self):
        ...
        self.rawDataDirPath = self.currentDirPath + "/5raw_images"
        ...
        self.bgDataDirPath = self.currentDirPath + "/4background_cropped"
        ...
        self.imagesDirPath = self.currentDirPath + "/6images_with_bg"
